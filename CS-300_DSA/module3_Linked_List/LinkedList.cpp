...
void LinkedList::Remove(string bidId) {
    ...
    while(current != nullptr) //
    {
        ...
        if(current-> bid.bidId == current-> next-> bid.bidId)
        {
...
Bid LinkedList::Search(string bidId) {
    ...
    if(head-> bid.bidId == bidId) //prior to spending the time and memory to initiate the search loop, if bidId of the head element is the same as the search key
    {
...
int main(int argc, char* argv[]) {
    ...
    while (choice != 9) {
        ...
        case 5:
            ...
            // cout << "Bid Id: " << bidKey << " removed." << endl; //output added for validation
